...
{
    [HideInInspector]
    public TilemapRenderer tilemapRederer;

    public int order { get { return tilemapRederer.sortingOrder; } }
    ...
    void Awake()
    {
        tilemapRederer = this.transform.GetComponent<TilemapRenderer>();
